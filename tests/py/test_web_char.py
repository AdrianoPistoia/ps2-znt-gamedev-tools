"""Editar personajes desde la web: renombrar id, nombre visible y color."""
import tempfile, os
...
assert st.stage("s", 1)["say"]["name"] == "Ana Ruiz", "el escenario usa el nombre nuevo"
