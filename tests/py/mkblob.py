"""Genera en el directorio dado un blob k.vnp de prueba (con sprite PNG 2x2, audio y
fuente) para el lector C: `python3 tests/py/mkblob.py <dir>`. Lo usan run_all.sh y checklist.sh."""
